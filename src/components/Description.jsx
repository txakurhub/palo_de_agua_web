    ...
    <div className="flex flex-col justify-center items-start">
      ...
      <div className="flex flex-col justify-center items-start text-start w-11/12">
        <h2 className="text-xl font-medium pb-1">
          ...
          rinconcito del continente, Palo de Agua crece como un colectivo de
          música en canciones, para seguir compartiendo el viaje. Es un proyecto
          que nace en San Cristóbal de las Casas, Chiapas, México, pero sus
          orígenes están nutridos por años de búsqueda constante. Procurando en
          cada territorio maestros y maestras como fuente de conocimiento,
          viajar por latinoamérica se volvió una escuela de artes, que está
          presente en cada canción.
        </h2>
      </div>
    </div>
  );
